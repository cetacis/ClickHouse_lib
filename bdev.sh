...
dev* | ori*)
    ...
    function configure() {
        ...
        cmake $source_dir -DCLICKHOUSE_SPLIT_BINARY=0 -DENABLE_REPLXX=1 -DENABLE_READLINE=1 -DUSE_DEBUG_HELPERS=1 -DUSE_STATIC_LIBRARIES=0 -DSPLIT_SHARED_LIBRARIES=1 -DCMAKE_BUILD_TYPE=RelWithDebInfo -DENABLE_LIBRARIES=0 -DUSE_UNWIND=1 -DENABLE_HDFS=1 -DENABLE_PROTOBUF=1 -DENABLE_TESTS=0 -DENABLE_UTILS=0 $compiler
    }
    ;;
dbg*)
    function configure() {
        cmake ../src -DCLICKHOUSE_SPLIT_BINARY=0 -DENABLE_REPLXX=1 -DENABLE_READLINE=1 -DUSE_DEBUG_HELPERS=1 -DUSE_STATIC_LIBRARIES=0 -DSPLIT_SHARED_LIBRARIES=1 -DCMAKE_BUILD_TYPE=Debug -DENABLE_LIBRARIES=0 -DUSE_UNWIND=1 -DENABLE_HDFS=1 -DENABLE_PROTOBUF=1 -DENABLE_TESTS=0 -DENABLE_UTILS=0 $compiler
...
kwai*)
    function configure() {
        cmake ../src -DCLICKHOUSE_SPLIT_BINARY=0 -DENABLE_REPLXX=1 -DENABLE_READLINE=1 -DUSE_DEBUG_HELPERS=1 -DUSE_SIMDJSON=0 -DENABLE_CAPNP=0 -DUSE_STATIC_LIBRARIES=0 -DSPLIT_SHARED_LIBRARIES=1 -DCMAKE_BUILD_TYPE=Debug -DADD_GDB_INDEX_FOR_GOLD=1 -DENABLE_BROTLI=0 -DENABLE_PARQUET=0 -DENABLE_ORC=0 -DENABLE_PROTOBUF=1 -DENABLE_BASE64=0 -DENABLE_HYPERSCAN=0 -DENABLE_RAPIDJSON=0 -DENABLE_HDFS=1 -DENABLE_CAPNP=0 -DENABLE_RDKAFKA=0 -DENABLE_MYSQL=0 -DENABLE_ODBC=0 -DENABLE_EMBEDDED_COMPILER=0 -DENABLE_UTILS=0 -DARCH_NATIVE=1 -DENABLE_TESTS=0 -DENABLE_UTILS=0 $compiler
        # cmake ../src -DUSE_UNWIND=1 -DUSE_DEBUG_HELPERS=1 -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_SYSCONFDIR=/etc -DCMAKE_INSTALL_LOCALSTATEDIR=/var -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY=ON -DENABLE_EMBEDDED_COMPILER=0 -DENABLE_TESTS=0 -DENABLE_UTILS=0 -DCMAKE_CXX_FLAGS="-fomit-frame-pointer" -DCMAKE_C_FLAGS="-fomit-frame-pointer" -DCMAKE_EXE_LINKER_FLAGS="-Wl,--dynamic-linker,$ld" $compiler
    }
    ;;
rs*)
    function configure() {
        cmake ../src -DUSE_UNWIND=1 -DUSE_DEBUG_HELPERS=1 -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=None -DCMAKE_INSTALL_SYSCONFDIR=/etc -DCMAKE_INSTALL_LOCALSTATEDIR=/var -DCMAKE_FIND_PACKAGE_NO_PACKAGE_REGISTRY=ON -DENABLE_EMBEDDED_COMPILER=0 -DENABLE_TESTS=0 -DENABLE_UTILS=0 -DCMAKE_EXE_LINKER_FLAGS="-s -Wl,--dynamic-linker,$ld" $compiler
    }
    ;;
rel*)
    function configure() {
